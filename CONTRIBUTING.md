# Contributing to CloudRevo

Thank you for your interest in contributing to CloudRevo!
...
**👉 https://github.com/dadastory/CloudRevo/blob/master/CONTRIBUTING.md**

A few key points to keep in mind before you open a PR:

- CloudRevo is dual-licensed. We only accept contributions to the **community
  edition**, and all contributors must sign the
  [CLA](https://github.com/dadastory/CloudRevo) before a PR can be merged.
...
- If you use AI tools to help write code, please read the
  [AIGC Guidelines](https://github.com/dadastory/CloudRevo/blob/master/CONTRIBUTING.md#aigc-guidelines)
